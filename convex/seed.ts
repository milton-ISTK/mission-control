...
const WORKFLOW_TEMPLATES = [
  // ---- 6.1 Blog Post (10-step with Legal Review integration) ----
  {
    name: "Blog Post",
    description: "Blog workflow with legal review: research → writing → humanization → content review → legal review → HTML → design → publish",
    ...
    steps: [
      ...
      },
      {
        stepNumber: 3,
        name: "Blog Writing",
        description: "Write full blog post draft using research and sentiment data",
      ...
      },
      {
        ...
        description: "Review and polish to remove AI tells and add personality",
        agentRole: "humanizer",
        requiresApproval: false,
        timeoutMinutes: 5,
      },
      {
        stepNumber: 5,
        name: "Content Review",
        description: "Review and edit the humanized blog post draft",
        agentRole: "none",
        requiresApproval: true,
        approvalPrompt: "Review the blog post draft. Approve, reject with feedback, or edit directly.",
        timeoutMinutes: 0,
      },
      {
        stepNumber: 6,
        name: "Create Legal Review Doc",
        description: "Auto-create a Google Doc from the approved draft for counsel review",
      ...
      },
      {
        ...
        agentRole: "none",
        requiresApproval: true,
        approvalPrompt: "Review the HTML blog page. Preview and approve for publishing.",
        timeoutMinutes: 0,
      },
      {
        stepNumber: 10,
