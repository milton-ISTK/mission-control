...
const WORKFLOW_TEMPLATES = [
  // ---- 6.1 Blog Post (10-step with image generation) ----
  {
    name: "Blog Post",
    description: "Full blog post workflow: research → headlines → writing → image generation → reviews → HTML → design → publish",
    ...
    steps: [
      ...
      },
      {
        ...
        description: "Generate 3 strategic image variations based on the headline",
      ...
      },
      {
        stepNumber: 6,
        name: "Image Review",
        description: "Select the preferred image from the 3 generated options",
        agentRole: "none",
        requiresApproval: true,
      ...
      },
      {
        stepNumber: 7,
        name: "Content Review",
        description: "Human review of the blog post and selected image",
        agentRole: "none",
        requiresApproval: true,
        approvalPrompt: "Review the blog post and confirm image choice",
        timeoutMinutes: 0,
      },
      {
        stepNumber: 8,
        name: "HTML Build",
        description: "Convert approved blog post into production-ready HTML with featured image",
